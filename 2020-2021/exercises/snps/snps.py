...
class SNP(AlleleVariation):
    ...
    '''
    def __init__(self, refBase : str, altBase : str, snpId : str, snpPosition : int, chromosomeName : str):
    ...
    def __del__(self):
    	pass
        #print('\tSNP %s has been removed.'%self.__snpId)
...
class Chromosome:
    ...
    def __del__(self):
        #print('Chromosome %s has been removed.'%self.__name)
        for snp in self.__snps:
            del snp
...
if __name__ == "__main__":
    ...
    with open('trio.sample.vcf') as csv_file:
        ...
        '''
        We destroy the chromosomes and their associated SNPs.
